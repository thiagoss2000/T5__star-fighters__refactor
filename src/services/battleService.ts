...
export async function battle(firstUser: fighterRepository.userNam, secondUser: fighterRepository.userNam) {
...
async function getFighterRepos(username: fighterRepository.userNam) {
...
async function getFighter(username: fighterRepository.userNam) {
